    ...
    internal class DeaCustDAL
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM [fatj].[dbo].[tbl_dea_cust]";
        ...
        public bool Insert(DeaCustBLL dc)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO [fatj].[dbo].[tbl_dea_cust] (type, name, email, contact, address, added_date, added_by) VALUES (@type, @name, @email, @contact, @address, @added_date, @added_by)";
        ...
        public bool Update(DeaCustBLL dc)
        {
            ...
            try
            {
                ...
                string sql = "UPDATE [fatj].[dbo].[tbl_dea_cust] SET type=@type, name=@name, email=@email, contact=@contact, address=@address, added_date=@added_date, added_by=@added_by WHERE id=@id";
        ...
        public bool Delete(DeaCustBLL dc)
        {
            ...
            try
            {
                ...
                string sql = "DELETE FROM [fatj].[dbo].[tbl_dea_cust] WHERE id=@id";
        ...
        public DataTable Search(string keyword)
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM [fatj].[dbo].[tbl_dea_cust] WHERE id LIKE '%"+keyword+"%' OR type LIKE '%"+keyword+"%' OR name LIKE '%"+keyword+"%'";
        ...
        public DeaCustBLL SearchDealerCustomerForTransaction(string keyword)
        {
            ...
            try
            {
                ...
                string sql = "SELECT name, email, contact, address from [fatj].[dbo].[tbl_dea_cust] WHERE id LIKE '%"+keyword+"%' OR name LIKE '%"+keyword+"%'";
        ...
        public DeaCustBLL GetDeaCustIDFromName(string Name)
        {
            ...
            try
            {
                ...
                string sql = "SELECT id FROM [fatj].[dbo].[tbl_dea_cust] WHERE name='"+Name+"'";
