    ...
    internal class productsDAL
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                String sql = "SELECT * FROM [fatj].[dbo].[tbl_products]";
        ...
        public bool Insert(productsBLL p)
        {
            ...
            try
            {
                ...
                String sql = "INSERT INTO [fatj].[dbo].[tbl_products] (name, category, description, rate, qty, added_date, added_by) VALUES (@name, @category, @description, @rate, @qty, @added_date, @added_by)";
        ...
        public bool Update(productsBLL p)
        {
            ...
            try
            {
                ...
                String sql = "UPDATE [fatj].[dbo].[tbl_products] SET name=@name, category=@category, description=@description, rate=@rate, added_date=@added_date, added_by=@added_by WHERE id=@id";
        ...
        public bool Delete(productsBLL p)
        {
            ...
            try
            {
                ...
                String sql = "DELETE FROM [fatj].[dbo].[tbl_products] WHERE id=@id";
        ...
        public DataTable Search (string keywords)
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM [fatj].[dbo].[tbl_products] WHERE id LIKE '%"+keywords+"%' OR name LIKE '%"+keywords+"%' OR category LIKE '%"+keywords+"%'";
        ...
        public productsBLL GetProductsForTransaction(string keyword)
        {
            ...
            try
            {
                ...
                string sql = "SELECT name, rate, qty FROM [fatj].[dbo].[tbl_products] WHERE id LIKE '%"+keyword+"%' OR name LIKE '%"+keyword+"%'";
        ...
        public productsBLL GetProductIDFromName(string ProductName)
        {
            ...
            try
            {
                ...
                string sql = "SELECT id FROM [fatj].[dbo].[tbl_products] WHERE name='" + ProductName + "'";
        ...
        public decimal GetProductQty(int ProductID)
        {
            ...
            try
            {
                ...
                string sql = "SELECT qty FROM [fatj].[dbo].[tbl_products] WHERE id = "+ProductID;
        ...
        public bool UpdateQuantity(int ProductID, decimal Qty)
        {
            ...
            try
            {
                ...
                string sql = "UPDATE [fatj].[dbo].[tbl_products] SET qty=@qty WHERE id=@id";
        ...
        public DataTable DisplayProductsByCategory(string category)
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM [fatj].[dbo].[tbl_products] WHERE category='"+category+"'";
