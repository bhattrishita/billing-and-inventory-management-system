    ...
    internal class transactionDAL
    {
        ...
        public bool Insert_Transaction(transactionsBLL t, out int transactionID)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO [fatj].[dbo].[tbl_transactions] (type, dea_cust_id, grandTotal, transaction_date, tax, discount, added_by) VALUES (@type, @dea_cust_id, @grandTotal, @transaction_date, @tax, @discount, @added_by); SELECT @@IDENTITY;";
        ...
        public DataTable DisplayAllTransactions()
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM [fatj].[dbo].[tbl_transactions]";
        ...
        public DataTable DisplayTransactionByType(string type)
        {
            ...
            {
                //Write SQL Query
                string sql = "SELECT * FROM [fatj].[dbo].[tbl_transactions] WHERE type='"+type+"'";
