    ...
    class transactionDetailDAL
    {
        ...
        public bool InsertTransactionDetail(transactionDetailBLL td)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO [fatj].[dbo].[tbl_transaction_details] (product_id, rate, qty, total, dea_cust_id, added_date, added_by) VALUES (@product_id, @rate, @qty, @total, @dea_cust_id, @added_date, @added_by)";
