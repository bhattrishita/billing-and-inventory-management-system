    ...
    internal class categoriesDAL
    {
        ...
        #region select method
            public DataTable Select(){
                ...
                try{
                    string sql = "SELECT * FROM [fatj].[dbo].[tbl_categories]";
       ...
       #region Insert New CAtegory
        public bool Insert(categoriesBLL c)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO [fatj].[dbo].[tbl_categories] (title, description, added_date, added_by) VALUES (@title, @description, @added_date, @added_by)";
        ...
        public bool Update(categoriesBLL c)
        {
            ...
            try
            {
                ...
                string sql = "UPDATE [fatj].[dbo].[tbl_categories] SET title=@title, description=@description, added_date=@added_date, added_by=@added_by WHERE id=@id";
        ...
        public bool Delete(categoriesBLL c)
        {
            ...
            try
            {
                ...
                string sql = "DELETE FROM [fatj].[dbo].[tbl_categories] WHERE id=@id";
        ...
        public DataTable Search(string keywords)
        {
            ...
            try
            {
                ...
                String sql = "SELECT * FROM [fatj].[dbo].[tbl_categories] WHERE id LIKE '%"+keywords+"%' OR title LIKE '%"+keywords+"%' OR description LIKE '%"+keywords+"%'";
